...
namespace Interaction.Compiler
{
    public class Activity
    {
        ...
        private bool compileAnswer()
        {
            ...
            {
                startPriority = prevAct.EndPriority + 1;
            ...
            lpInstruction = new ArrayList();
            string strInstruct = string.Format("exten => {0},{1},Answer({2})", new object[] { strCurrentExt, endPriority, strTimeout });
            lpInstruction.Add(strInstruct);
        ...
        private bool compileHangup()
        {
            ...
            lpInstruction = new ArrayList();
            string strInstruct = string.Format("exten => {0},{1},Hangup({2}) ", new object[] { strCurrentExt, endPriority, strVal });
            lpInstruction.Add(strInstruct);
        ...
        private bool compileMerge()
        {
            ...
            lpInstruction = new ArrayList();
            string strInstruct = string.Format("exten => {0},{1},Set({2}={3}{4}) ", new object[] { strCurrentExt, endPriority, strResult, strVal1, strVal2 });
            lpInstruction.Add(strInstruct);
        ...
        private bool compileLength()
        {
            ...
            lpInstruction = new ArrayList();
            string strInstruct = string.Format("exten => {0},{1},Set({2}={3}) ", new object[] { strCurrentExt, endPriority, strResult, strVal });
            lpInstruction.Add(strInstruct);
        ...
        private string FindExtension(Activity act)
        {
            ...
            Activity[] aryPrevAct = FindPreviousActivity(entryNode, true);
            Activity prevAct = null;

            if (aryPrevAct != null)
            {
                if (aryPrevAct.Length > 0)
                {
                    prevAct = aryPrevAct[0];
                }
            }
        ...
        private Activity[] FindPreviousActivity(Node thisEntry, bool stop)
        {
            bool foundAct = false;
            Activity[] act = null;
            ...
            {
                act = lstActivity.ToArray() as Activity[];
            }

            return act;
        }

        private Node[] FindPreviousNodeByEntryNode(Node entry, bool stop)
        {
            Node[] ret = null;
